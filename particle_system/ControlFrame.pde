...
class ControlFrame extends PApplet {
  ...
  public void setup() {
    ...
    // Recording frame data to csv file for performance comparison
    ...
    endRecording.onClick(new CallbackListener() {
        ...
        String filename;
        if (floorSwitch) {
            filename = String.format("../University/particle_system/blood_particle_system/particle_system/data/%s-floor-fps.csv", currentRenderMode);
        } else {
            filename = String.format("../University/particle_system/blood_particle_system/particle_system/data/%s-fps.csv", currentRenderMode);
        }
